...
const repositorySchema = z.object({
  ...
  reviewDocs: z.array(z.string()).default(["REVIEW_WORKFLOW.md"]),
...
const configSchema = z.object({
  ...
  codex: z.object({
    ...
    forkPriorReviewThread: z.boolean().default(false),
    reviewMode: z.enum(["structured-turn", "native-two-pass"]).default("structured-turn"),
...
export function loadConfig(configPath: string): ReviewQuillConfig {
  ...
  const codex = {
    ...
    forkPriorReviewThread: parsed.codex.forkPriorReviewThread,
    reviewMode: parsed.codex.reviewMode,
