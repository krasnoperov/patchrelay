...
export function maintenanceHelpText(): string {
  return [
    ...
    "  patchrelay maintenance prune-worktrees [options]",
    "",
    "Options for `prune-events`:",
    ...
    "  --help, -h                   Show this help",
    "",
    "Options for `prune-worktrees`:",
    "  --dry-run                    Count removable worktrees without deleting",
    "  --retention-hours <hours>    Override configured worktree retention window",
    "  --retention-days <days>      Override configured worktree retention window in days",
    "  --json                       Emit structured JSON output",
    "  --help, -h                   Show this help",
    "",
    "Behavior:",
    ...
    "  Worktree cleanup only removes clean managed worktrees for done, failed, or escalated issues",
    "  with no active run, and skips dirty tracked files.",
    "",
    "Examples:",
    "  patchrelay maintenance prune-events --dry-run",
    "  patchrelay maintenance prune-events --archive",
    "  patchrelay maintenance prune-worktrees --dry-run",
  ].join("\n");
}
