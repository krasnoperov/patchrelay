...
function mapRunRow(row: Record<string, unknown>): RunRecord {
  return {
    ...
    ...(row.last_codex_activity_at !== null ? { lastCodexActivityAt: String(row.last_codex_activity_at) } : {}),
    ...(row.last_codex_activity_kind !== null ? { lastCodexActivityKind: String(row.last_codex_activity_kind) } : {}),
    ...(row.last_codex_activity_summary !== null ? { lastCodexActivitySummary: String(row.last_codex_activity_summary) } : {}),
