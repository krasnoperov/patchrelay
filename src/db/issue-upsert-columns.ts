...
export const ISSUE_COLUMN_DEFS: Record<IssueColumnKey, IssueColumnDef> = {
  ...
  workflowOutcome: { column: "workflow_outcome" },
  workflowOutcomeReason: { column: "workflow_outcome_reason" },
  inputRequestKind: { column: "input_request_kind" },
  ...
  capacityBackoffAttempts: { column: "capacity_backoff_attempts", insertDefault: 0 },
